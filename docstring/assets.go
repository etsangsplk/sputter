...
func condMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "cond.md", size: 702, mode: os.FileMode(420), modTime: time.Unix(1495205838, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dropMd() (*asset, error) {
	bytes, err := dropMdBytes()
	if err != nil {
		return nil, err
	}
...
var _evalMd = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x52\x56\xd0\x48\x2d\x4b\xcc\x51\x48\xcb\x2f\xca\xd5\x54\x00\x31\x4b\x13\x4b\x52\x8b\x15\x12\xc1\x22\x5c\x80\x00\x00\x00\xff\xff\x0c\x47\x37\x7d\x1f\x00\x00\x00")

func evalMdBytes() ([]byte, error) {
	return bindataRead(
		_evalMd,
		"eval.md",
	)
...
func evalMd() (*asset, error) {
	bytes, err := evalMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "eval.md", size: 31, mode: os.FileMode(420), modTime: time.Unix(1495209228, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _mapMd = []byte("")
...
func reduceMd() (*asset, error) {
	bytes, err := reduceMdBytes()
	if err != nil {
		return nil, err
	}
...
func strMd() (*asset, error) {
	bytes, err := strMdBytes()
	if err != nil {
		return nil, err
	}
...
func takeMd() (*asset, error) {
	bytes, err := takeMdBytes()
	if err != nil {
		return nil, err
	}
...
func whenMd() (*asset, error) {
	bytes, err := whenMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "when.md", size: 468, mode: os.FileMode(420), modTime: time.Unix(1495357626, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"drop.md": &bintree{dropMd, map[string]*bintree{}},
	"eq.md": &bintree{eqMd, map[string]*bintree{}},
	"eval.md": &bintree{evalMd, map[string]*bintree{}},
	...
	"read.md": &bintree{readMd, map[string]*bintree{}},
	"reduce.md": &bintree{reduceMd, map[string]*bintree{}},
	...
	"str.md": &bintree{strMd, map[string]*bintree{}},
	"take.md": &bintree{takeMd, map[string]*bintree{}},
	...
	"when.md": &bintree{whenMd, map[string]*bintree{}},
