...
func filterMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "filter.md", size: 395, mode: os.FileMode(420), modTime: time.Unix(1492069812, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
